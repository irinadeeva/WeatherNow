                ...
                HStack {
                    VStack(alignment: .leading) {
                        ...
                        WeatherRow(logo: "thermometer",
                                   name: "Feels like",
                                   value: (weather.main.feelsLike.roundDouble() + "°"))
                        
                        WeatherRow(logo: "speedometer",
                                   name: "Pressure",
                                   value: (weather.main.pressure.notRoundDouble() + "hPa"))
                    }
                    ...
                    VStack(alignment: .leading) {
                        ...
                        WeatherRow(logo: "eye.fill",
                                   name: "Visibility",
                                   value: (weather.visibility.roundToKilometer() + " km"))
                        
                        WeatherRow(logo: "cloud.fill",
                                   name: "Cloudiness",
...
#Preview {
    WeatherRow(logo: "cloud.fill", name: "Cloudiness", value: "100 %")
}
